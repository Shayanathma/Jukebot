...
if menu == "Home":
    ...
    if user_input:
        ...
        st.session_state['chat_log'].append(f"JukeBot: {response}")
        st.write(f"{response}")
...
# About Section
    ...
    st.header("About:")
    st.write(" JukeBot is a music-related chatbot that can recommend songs, provide information about albums, artists, and more. ")
